...
- une liste d’activités horodatées
...
- L’utilisateur peut créer une sortie en saisissant un titre, en sélectionnant des participants et en ajoutant des activités avec heure.
...
- Le formulaire de création utilise des chips pour les utilisateurs et des sélecteurs d’heure pour garder la saisie rapide sur mobile.
