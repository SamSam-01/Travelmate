...
Elle permet de rechercher un utilisateur par son username, d'envoyer une demande d'ami, de traiter les demandes reçues et de limiter l'accès aux profils complets aux seules relations acceptées.
